        ...
        return m(Layout, [
            ...
            m("div", { class: styles.tableOfContents }, [
                m("section", { class: styles.professional }, [
                    ...
                    m("p", "I am currently a software development engineer with ", m("a", { href: "https://games.amazon.com/", target: "_blank", rel: "noopener" }, "Amazon Game Studios"), ". When I'm not performing mad science experiments, I write gameplay, systems, and UI/UX code."),
                    m("p", "Previously, I was a software development engineer intern inside ", m("a", { href: "https://aws.amazon.com/", target: "_blank", rel: "noopener" }, "Amazon Web Services"), ". I was exposed to a variety of image processing and video encoding domain topics while working on real-time streaming backends. Before that, I was a summer student at the ", m("a", { href: "https://www.nrl.navy.mil/", target: "_blank", rel: "noopener" }, "United States Naval Research Laboratory"), ". I performed research on experimental and theoretical projects in fields of study including: underwater electrical discharges, target tracking, and parallel computing."),
                    m("p", [
                ...
                m("section", { class: styles.undergraduate }, [
                    ...
                    m("p", [
                        ...
                        m("a", { href: "https://www.hass.rpi.edu/pl/gaming/", target: "_blank", rel: "noopener" }, "Games and Simulation Arts and Sciences"),
                        " program at ",
                        m("a", { href: "https://rpi.edu/", target: "_blank", rel: "noopener" }, "Rensselaer Polytechnic Institute"),
